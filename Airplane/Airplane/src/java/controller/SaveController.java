...
public class SaveController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean isDelay = Boolean.parseBoolean(request.getParameter("isDelay"));
            
            Airplanes stu = new Airplanes(id, destination, departureTime, isDelay);
            DAO dao = new DAO();
            boolean checkInsert = dao.inser(stu);
            if (checkInsert) {
